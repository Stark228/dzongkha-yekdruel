import { StyleSheet, Text, View ,TouchableWithoutFeedback,
    Animated,Modal,Button,TextInput,TouchableOpacity,ImageBackground, Platform, Alert} from 'react-native'
...
const FloatButton = ({value,value1,value2,date,reason,...props}) => {
    ...
    const [saveLetterName,setSaveLetterName] = useState('');
 ...
 const uploadletter = () => {
     firebase.firestore().collection('Letter').add({
                ...
                .then(()=>{
                    Alert.alert('',"Your letter has been successfully uploaded")
                    setPostModal(false)
                })
                .catch((error) => {
                    alert(error.message)
     ...
     const saveletter = () => {
                firebase.firestore().collection('SaveLetter').add({
                               saveLetterName,
                               value,
                               value1,
                               value2,
                           ...
                           .then(()=>{
                               Alert.alert('',"Your letter has been saved in the draft!")
                               setModal(false)
                           })
                           .catch((error) => {
                               alert(error.message)
        ...
        animationType='fade'>
          <View style={styles.modalConatiner}>
              ...
              <ImageBackground source={{uri:'https://docplayer.net/docs-images/56/38903454/images/59-0.jpg'}} resizeMode='contain' style={{width:'100%',height:'100%'}} imageStyle={styles.bgImage}>
                ...
                value={saveLetterName}
                onChangeText={(text)=>{setSaveLetterName(text)}}
                />
                </View>
                ...
                <View style={styles.buttonContainer}>
                    ...
                    <TouchableOpacity onPress={saveletter}>
                    <View style={styles.Moadlbutton}>
          ...
          <View style={styles.modalConatiner}>
              ...
              <ImageBackground source={require('../../assets/Image/postBg.png')} resizeMode='contain' style={{width:'100%',height:'100%'}} imageStyle={styles.bgImage}>
                ...
                <View style={styles.buttonContainer}>
                    ...
                    <TouchableOpacity onPress={uploadletter}>
                    <View style={styles.Moadlbutton}>
