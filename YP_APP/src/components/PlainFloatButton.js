import { StyleSheet, Text, View ,TouchableWithoutFeedback,
    Animated,Modal,Button,TextInput,Pressable,ImageBackground,TouchableOpacity, Platform} from 'react-native'
...
const PlainFloatButton = ({content,...props}) => {
...
export default PlainFloatButton
